...
%%%   SET THE TITLE   %%%
\newcommand{\preprinttitle}{Analysis of the Dated Archaeological Record through Approximate Bayesian Computation}
%%%%%%%%%%%%%%%%%%%%%%%%%
...
\begin{figure}[tbh]
\center\includegraphics[width=6cm]{../../results/method_evaluation/OOB_p_spd.pdf} \includegraphics[width=6cm]{../../results/method_evaluation/OOB_p_hist.pdf} \includegraphics[width=6cm]{../../results/method_evaluation/OOB_p_hist2.pdf}
...
\begin{figure}[tbh]
\center\includegraphics[width=6cm]{../../results/method_evaluation/OOB_lambda_rate.pdf} \includegraphics[width=6cm]{../../results/method_evaluation/OOB_lambda_0.pdf} \includegraphics[width=6cm]{../../results/method_evaluation/OOB_p_rate.pdf}
\includegraphics[width=6cm]{../../results/method_evaluation/OOB_p_0.pdf}
\caption{\textbf{XXXXXXXXXX.} (a) SPD (b) hist1 (c) hist2.}
\label{fig:summary_stats}
\end{figure}
